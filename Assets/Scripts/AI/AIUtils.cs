...
{
    public static bool ApproximatePositionReached(Vector3 a, Vector3 b, float dist = GlobalAISettings.DISTANCE_THRESHOLD)
    {
        return Vector2.Distance(new Vector2(a.x, a.z), new Vector2(b.x, b.z)) <= dist;
    }
